					...
					<div className="flex flex-col items-center justify-center space-y-4 text-center">
						<div className="space-y-2">
							...
							<p className="max-w-[900px] text-gray-500 dark:text-gray-400 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
								Our AI analyzes historical stock market data more more Lorem ipsum dolor sit, amet consectetur
								adipisicing elit. Voluptatum enim saepe quidem!
							</p>
						</div>
					</div>
				...
				<div className="container grid items-center justify-center gap-6 px-4 text-center md:px-6">
					<div className="space-y-3">
						...
						<p className="mx-auto max-w-[600px] text-gray-500 dark:text-gray-400 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
							Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptate laudantium officiis obcaecati!
						</p>
					</div>
