			...
			<div className="container z-10 px-4 md:px-6">
				<div className="flex flex-col items-center space-y-4 text-center">
					<div className="space-y-2">
						<h1 className="text-3xl font-bold tracking-tighter text-green-800 sm:text-4xl md:text-5xl lg:text-6xl/none">
							Trade Smarter, Not Harder
						</h1>
						<p className="mx-auto max-w-[700px] text-sky-700 md:text-xl">
